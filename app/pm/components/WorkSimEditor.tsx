        ...
        <div className="flex h-full overflow-hidden bg-[#0A0A0A]">
                    ...
                    <div className="space-y-3">
                        ...
                        <div className="relative group">
                            <textarea
                                ...
                                className="w-full h-40 bg-black/40 border border-white/10 rounded-xl p-4 text-xs text-white/80 focus:outline-none focus:border-blue-500/50 resize-none font-mono leading-relaxed"
                            />
                        ...
                        <div className="space-y-2">
                            {RUBRIC_CRITERIA.map((c, i) => (
                                <div key={i} className="flex items-center gap-3 p-3 rounded-lg bg-white/[0.02] border border-white/5">
                                    <div className="w-8 h-8 rounded bg-white/5 flex items-center justify-center text-xs font-bold text-emerald-400">
                                        {c.weight}
                                    </div>
                                    <div>
            ...
            <div className="flex-1 flex flex-col relative">
                ...
                <div className="flex-1 p-8 flex items-center justify-center">
                    <div className="w-full max-w-2xl bg-[#0F0F0F] rounded-2xl border border-white/10 shadow-2xl overflow-hidden flex flex-col h-[500px]">
                        {/* Fake Browser Header */}
                        ...
                        <div className="flex-1 flex">
                            ...
                            <div className="w-1/3 border-r border-white/5 p-4 space-y-4">
                                <div className="flex items-start gap-2">
                                    <div className="w-6 h-6 rounded bg-blue-500 flex items-center justify-center text-xs font-bold text-white">F</div>
                            ...
                            {/* Fake Code Editor */}
                            <div className="flex-1 bg-[#090909] p-4 font-mono text-[11px]">
                                <div className="flex gap-4 text-white/30 mb-4 border-b border-white/5 pb-2">
                                    <span className="text-white border-b border-blue-500 pb-2">App.tsx</span>
                                    <span>utils.ts</span>
                                    <span>styles.css</span>
                                </div>
                                <div className="space-y-1 text-white/60">
                                    <div className="flex gap-4"><span className="text-white/20 w-4">1</span> <span className="text-purple-400">import</span> React <span className="text-purple-400">from</span> "react";</div>
                                    <div className="flex gap-4"><span className="text-white/20 w-4">2</span></div>
                                    <div className="flex gap-4"><span className="text-white/20 w-4">3</span> <span className="text-blue-400">export default function</span> App() {"{"}</div>
                                    <div className="flex gap-4"><span className="text-white/20 w-4">4</span>   <span className="text-green-400">// TODO: Implement solution</span></div>
                                    <div className="flex gap-4"><span className="text-white/20 w-4">5</span>   <span className="text-purple-400">return</span> (</div>
                                    <div className="flex gap-4"><span className="text-white/20 w-4">6</span>     &lt;<span className="text-red-400">div</span>&gt;Hello World&lt;/<span className="text-red-400">div</span>&gt;</div>
