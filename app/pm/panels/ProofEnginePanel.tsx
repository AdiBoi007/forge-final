...
export default function ProofEnginePanel({ onClose }: { onClose: () => void }) {
    ...
    return (
        <div className="h-full flex flex-col bg-[#030303] text-white selection:bg-cyan-500/30">
            {/* Header */}
            ...
            <div className="px-8 pt-4 pb-2 border-b border-white/[0.06] flex gap-6 overflow-x-auto">
                {TABS.map(t => (
                    <button
                        ...
                        className={`group relative flex items-center gap-2 pb-3 text-sm font-medium transition-colors ${tab === t.key ? 'text-cyan-400' : 'text-white/40 hover:text-white/80'
                            }`}
                    >
                        <t.icon className={`w-4 h-4 ${tab === t.key ? 'text-cyan-400' : 'text-white/40 group-hover:text-white/60'}`} />
                        {t.label}
                        {tab === t.key && (
                            <motion.div
                                layoutId="active-tab"
    ...
    return (
        <div className="space-y-8">
            ...
            <div className="grid grid-cols-3 gap-6">
                <div className="col-span-2 rounded-3xl border border-white/[0.06] bg-[#08080A] p-6 relative overflow-hidden group">
                    {/* Gradient BG */}
                ...
                <div className="rounded-3xl border border-white/[0.06] bg-[#08080A] p-6 flex flex-col justify-between relative overflow-hidden">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {Object.entries(grouped).map(([name, items], idx) => (
                    <motion.div
                        ...
                        className="rounded-3xl border border-white/[0.06] bg-[#08080A] overflow-hidden hover:border-white/10 transition-colors"
                    >
        ...
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-2 gap-4">
                {DEMO_SANDBOXES.map((sb, i) => {
                    ...
                    return (
                        <div key={sb.id} className="relative group rounded-2xl border border-white/[0.08] bg-[#0A0A0C] p-6 hover:border-cyan-500/30 transition-all duration-300 overflow-hidden">
                            ...
                            <div className="flex items-center gap-3 mb-4">
                                <div className="w-10 h-10 rounded-lg bg-white/5 flex items-center justify-center border border-white/5">
                                    <Box className="w-5 h-5 text-white/60 group-hover:text-cyan-400 transition-colors" />
                                </div>
                                <div>
    ...
    return (
        <div className="grid grid-cols-3 gap-6">
            ...
            <div className="space-y-4">
                <div className="rounded-2xl border border-white/10 bg-[#0A0A0C] p-6 text-center">
                ...
                <div className="rounded-2xl border border-white/10 bg-[#0A0A0C] p-6 text-center relative overflow-hidden">
            ...
            <div className="col-span-2 rounded-3xl border border-white/10 bg-[#0A0A0C] p-6 flex flex-col items-center justify-center relative">
                    ...
                    <div className="space-y-4 border-l border-white/10 pl-4">
                        {r.events.map((ev, i) => (
                            <div key={i} className="relative">
                                <div className="absolute -left-[21px] top-1.5 w-2.5 h-2.5 rounded-full bg-[#0A0A0C] border border-white/20" />
